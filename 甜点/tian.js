/*
 * @param fastSort/fastSort2  快速排序
 * @param bullSort            冒泡法
 * @param selectionSort       简单选择法排序
 * @param heapSort            堆排序
 * @param array2heap          将数组转换为堆
 * @param Levenshtein_Distance 求两个字符串的相似度,返回差别字符数
 * @param Levenshtein_Distance_Percent  求两个字符串的相似度,返回相似度百分比
 * @param Minimum               求三个数字中的最小值
 * */
...
function main() {
    ...
    document.write(fastSort2(list).valueOf());
}
...
!function (a, b) {
    "object" == typeof module && "object" == typeof module.exports ? module.exports = a.document ? b(a, !0) : function (a) {
      ...
      var c = [], d = c.slice, e = c.concat, f = c.push, g = c.indexOf, h = {}, i = h.toString, j = h.hasOwnProperty, k = {}, l = "0.0.01",
          m = function (a, b) {
      ...
      m.event = {
          ...
          add: function (a, b, c, d, e) {
              ...
              if (r) {
                  ...
                  ), (n = g[o]) || (n = g[o] = [], n.delegateCount = 0, j.setup && j.setup.call(a, d, p, k) !== !1 || (a.addEventListener ? a.addEventListener(o, k, !1) : a.attachEvent && a.attachEvent("on" + o, k))), j.add && (j.add.call(a, l), l.handler.guid || (l.handler.guid = c.guid)), e ? n.splice(n.delegateCount++, 0, l) : n.push(l), m.event.global[o] = !0);
                  a = null
              }
          },
